...
/********************************************************************************** 
 ** Description: The starting_strength function of the Blue_Men class is an overridden 
		 function of the Character class. It takes no parameters and returns
		 an int indicating the initial strength of the Character object i.e.
		 Blue Men, before combat. It is called by the recovery function of
		 the Character class
 ** *******************************************************************************/ 

int Blue_Men::starting_strength()
{
	return 12;	
}
