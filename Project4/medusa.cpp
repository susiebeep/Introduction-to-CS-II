...
/********************************************************************************** 
 ** Description: The starting_strength function of the Medusa class is an overridden 
		 function of the Character class. It takes no parameters and returns
		 an int indicating the initial strength of the Character object i.e.
		 Medusa, before combat. It is called by the recovery function of the
		 Character class
 ** *******************************************************************************/ 

int Medusa::starting_strength()
{
	return 8;	
}
